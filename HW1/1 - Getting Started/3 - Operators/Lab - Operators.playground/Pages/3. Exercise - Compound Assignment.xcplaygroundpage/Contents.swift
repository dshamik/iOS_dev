...
myVariable += 5
print("After addition: \(myVariable)")

myVariable *= 2
print("After multiplication: \(myVariable)")
...
piggyBank += 10
print("Balance after neighbor pays you: \(piggyBank) dollars")

piggyBank += 20
print("Balance after earning from odd jobs: \(piggyBank) dollars")

piggyBank /= 2
print("Balance after spending on dinner and a movie: \(piggyBank) dollars")

piggyBank *= 3
print("Balance after tripling by washing windows: \(piggyBank) dollars")

piggyBank -= 3
print("Balance after spending at a convenience store: \(piggyBank) dollars")
