...
progressUpdate(steps: 12, goal: 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    if projectedDistance >= totalDistance {
        print("Keep it up!")
        print(projectedDistance)
    } else {
...
pacing(currentDistance: 54.3, totalDistance: 100.0, currentTime: 32.6, goalTime: 60.0)
